 ...
 *  - Dynamic Init        : Empty collection populated later as bogies are added
 */
public class TrainManagementApp {
    ...
    public static void main(String[] args) {
        ...
        // Initialize an empty List<String> using ArrayList
        // The train consist starts with ZERO bogies attached to the engine
